...
public class Student_login extends JFrame implements ActionListener {
    ...
    public Student_login(){
       ...
       panel = new JPanel();
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(128, 128, 0), 3), "Log In As Student", 
    ...
    ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("course/management/system/icons/student.png"));
  ...
  public void actionPerformed(ActionEvent ae){
           ...
           Boolean status=false;
            try{
                ...
                if(rs.next()){
                    ...
                    new loading_student().setVisible(true);
                }else{
        ...
        if(ae.getSource()== but2){
            setVisible(false);
            new Student_forgot().setVisible(true);
        }
    }
