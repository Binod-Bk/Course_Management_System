...
public class Student_forgot extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()== but){
            ...
            String sql="Select * from student where uname=?";
              ...
              while(rs.next()){
                  combo2.setSelectedItem(rs.getString("security_question"));
        ...
        if(ae.getSource()== but1){
            ...
            String sql1 ="Select * from student where answer=?";
