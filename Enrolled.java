...
public class Enrolled extends JFrame implements ActionListener {
    ...
    public Enrolled(){
       ...
       panel = new JPanel();
        ...
        l2 = new JLabel("Select Your Semester :");
    ...
    but1=new JButton("Show My Course.");  
    but1.setBounds(500,280,180,40);  
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()== but1){
         ...
         st.setString(1,(String)combo.getSelectedItem());
